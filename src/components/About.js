    ...
    <>
      <AboutContainer ref={ref} $aboutStatus={aboutStatus}>
        ...
        <P>
          ...
          rap que resonó en Vitoria y sus alrededores durante los años
          ...
          infancia y juventud. Con esta web, no solo buscamos rendir homenaje a
          esos artistas y sus creaciones, sino también ofrecer un espacio de
          reencuentro con esos momentos. Es importante mencionar que no buscamos
          infringir derechos ni molestar a los artistas involucrados. Si algún
          artista prefiere no estar representado aquí, solo necesita ponerse en
          contacto con uno de los autores, ya sea{" "}
        ...
        <P>
          ...
          los archivos musicales al formato <Remark href="#">m4a</Remark>. Esta
          decisión permite una reproducción de alta calidad mientras se mantiene
          un tamaño de archivo reducido, garantizando así una experiencia de
          usuario óptima.
        </P>
        <H2>Tecnología y diseño</H2>
        <P>
          Esta web ha sido desarrollada utilizando{" "}
          <Remark href="#">React</Remark>, una de las bibliotecas más populares
          y potentes para la creación de interfaces de usuario. Al no contar con
          un backend, toda la lógica y el contenido se ejecutan directamente en
          el navegador del usuario, lo que garantiza una experiencia fluida y
          rápida.
        </P>
      </AboutContainer>
      <CloseButton
