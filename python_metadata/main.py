...
def replace_paths(songs):
    for song in songs:
        song["audio"] = song["audio"].replace("/mnt/d/Biblioteca/Descargas/Rap Vitoria/", "https://retrogasteiz.blob.core.windows.net/gasteizkorap/")
        song["cover"] = song["cover"].replace("/mnt/d/Biblioteca/Descargas/Rap Vitoria/", "https://retrogasteiz.blob.core.windows.net/gasteizkorap/")
    return songs
